...
impl Default for ListInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ListBuilder {
    ...
    #[inline(always)]
    pub fn listing_amount(&mut self, listing_amount: u64) -> &mut Self {
        self.listing_amount = Some(listing_amount);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = ListInstructionArgs {
            listing_amount: self
                .listing_amount
                .clone()
                .expect("listing_amount is not set"),
...
impl<'a, 'b> ListCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn listing_amount(&mut self, listing_amount: u64) -> &mut Self {
        self.instruction.listing_amount = Some(listing_amount);
        self
    }
    #[inline(always)]
    pub fn payment_mint(&mut self, payment_mint: Pubkey) -> &mut Self {
