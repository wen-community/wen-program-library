...
impl<'a> TryFrom<&solana_program::account_info::AccountInfo<'a>> for TokenGroup {
...
impl anchor_lang::IdlBuild for TokenGroup {}

#[cfg(feature = "anchor-idl-build")]
impl anchor_lang::Discriminator for TokenGroup {
