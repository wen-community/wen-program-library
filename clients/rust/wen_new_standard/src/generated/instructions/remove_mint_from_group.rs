...
/// Accounts.
pub struct RemoveMintFromGroup {
...
impl RemoveMintFromGroup {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = RemoveMintFromGroupInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct RemoveMintFromGroupInstructionData {
    discriminator: [u8; 8],
}

impl RemoveMintFromGroupInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [231, 224, 145, 240, 192, 4, 204, 218],
        }
    }
}

impl Default for RemoveMintFromGroupInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `RemoveMintFromGroup`.
///
/// ### Accounts:
///
...
pub struct RemoveMintFromGroupBuilder {
...
impl RemoveMintFromGroupBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RemoveMintFromGroup {
...
/// `remove_mint_from_group` CPI accounts.
pub struct RemoveMintFromGroupCpiAccounts<'a, 'b> {
...
/// `remove_mint_from_group` CPI instruction.
pub struct RemoveMintFromGroupCpi<'a, 'b> {
...
impl<'a, 'b> RemoveMintFromGroupCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RemoveMintFromGroupCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RemoveMintFromGroup` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   7. `[]` token_program
#[derive(Clone, Debug)]
pub struct RemoveMintFromGroupCpiBuilder<'a, 'b> {
    instruction: Box<RemoveMintFromGroupCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveMintFromGroupCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveMintFromGroupCpiBuilderInstruction {
            __program: program,
            payer: None,
            authority: None,
            group: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = RemoveMintFromGroupCpi {
...
#[derive(Clone, Debug)]
struct RemoveMintFromGroupCpiBuilderInstruction<'a, 'b> {
