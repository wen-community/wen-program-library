...
impl BurnMintAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = BurnMintAccountInstructionData::new().try_to_vec().unwrap();
...
pub struct BurnMintAccountInstructionData {
    discriminator: [u8; 8],
}

impl BurnMintAccountInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for BurnMintAccountInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `BurnMintAccount`.
///
/// ### Accounts:
///
...
pub struct BurnMintAccountBuilder {
...
/// `burn_mint_account` CPI accounts.
pub struct BurnMintAccountCpiAccounts<'a, 'b> {
...
/// `burn_mint_account` CPI instruction.
pub struct BurnMintAccountCpi<'a, 'b> {
...
impl<'a, 'b> BurnMintAccountCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: BurnMintAccountCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `BurnMintAccount` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   5. `[]` token_program
#[derive(Clone, Debug)]
pub struct BurnMintAccountCpiBuilder<'a, 'b> {
    instruction: Box<BurnMintAccountCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> BurnMintAccountCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(BurnMintAccountCpiBuilderInstruction {
            __program: program,
            payer: None,
            user: None,
            mint: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = BurnMintAccountCpi {
...
#[derive(Clone, Debug)]
struct BurnMintAccountCpiBuilderInstruction<'a, 'b> {
