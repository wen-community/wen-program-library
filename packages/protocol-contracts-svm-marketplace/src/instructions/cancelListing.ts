import {
  ...
  export const cancelListing = async ({
    ...
    const tokenProgramMint = await getTokenProgramFromMint(provider, order.nftMint.toBase58());
    const initializerNftTa = getAtaAddress(
        order.nftMint.toBase58(),
        initializer,
        tokenProgramMint.toString()
      );
    ...
    console.log("initializerNftTa:", initializerNftTa.toBase58());
